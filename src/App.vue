  ...
  <div class="shell">
    ...
    <main>
      <section v-if="page==='practice'" class="practice-page">
        ...
        <div v-if="loading" class="feedback-card loading-card" aria-live="polite">正在评估<span class="loading-dots">...</span></div>

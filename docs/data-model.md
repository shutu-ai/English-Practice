...
SQLite schema version 1 includes `user_profile`, `scenes`, `communication_intents`, `sentence_patterns`, `exercises`, `sessions`, `attempts`, `evaluations`, `pattern_mastery`, `scene_mastery`, `error_stats`, `review_schedule`, `llm_providers`, and `llm_task_configs`.
